 ...
 shadow-sm sm:rounded-lg text-gray-900 dark:text-gray-50">
            ...
            @else
                <div class="font-base text-sm text-gray-700 dark:text-gray-300">
                    <x-disciplines.table :disciplines="$cart" :showView="false" :showEdit="false" :showDelete="false"
                    ...
                    <div class="flex justify-between space-x-12 items-end">
                        <div>
                            ...
                            <form action="{{ route('cart.confirm') }}" method="post">
                                @csrf
                                <x-field.input name="student_number" label="Student Number" width="lg" :readonly="false"
